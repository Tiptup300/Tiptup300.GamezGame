...
using Tiptup300.Slaam.GamezGame.Metrics;
using Tiptup300.Slaam.GamezGame.ResourceManagement;
...
public class Composer
{
   ...
   private void register(int width, int height)
   {
      ...
      _container.Register<MonoGameRunner>(Lifestyle.Singleton);
      _container.Register<GamerzMonoGame>(Lifestyle.Singleton);
   ...
   private void registerScreens()
   {
      ...
      _container.RegisterSingleton(typeof(IResolver<>), typeof(MonoGameRunner).Assembly);
      _container.RegisterSingleton(typeof(IResolver<,>), typeof(MonoGameRunner).Assembly);
   }
